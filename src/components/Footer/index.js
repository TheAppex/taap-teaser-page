...
const Footer = () => (
  <div className="p-3 bg-darkPrimary antialiased">
    ...
    <p className="font-body text-textIcons text-xs xl:text-sm w-full leading-normal text-center"> © 2018 · All rights reserved · <a href="mailto:hello@theappex.com" className="text-textIcons text-xs xl:text-sm w-full leading-normal text-center">Contact Us</a></p>
