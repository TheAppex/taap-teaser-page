...
const Footer = () => (
  <div className="p-3 bg-darkPrimary antialiased">
    <div className="flex justify-center container mx-auto px-4">
      <a href="http://twitter.com/TheAppexHQ"  target="_blank"><img className="h-4 fill-current text-textIcons rounded m-2" src={twitterSVG}></img></a>
      <a href="http://medium.com/TheAppex"  target="_blank"><img className="h-4 fill-current text-textIcons rounded m-2" src={mediumSVG}></img></a>
      <a href="http://facebook.com/TheAppex"  target="_blank"><img className="h-4 fill-current text-textIcons rounded m-2" src={facebookSVG}></img></a>
    </div>
