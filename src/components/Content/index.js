...
const Content = () => (
  ...
  <div className="flex flex-col">
		<div className="flex content-around justify-center h-64">
			<div>
			<p className="font-body align-middle">Overwhelmed by how many different apps there are for ____ ??</p>
			<p className="font-title align-middle">We are too.</p>
			</div>
			<img className="h-48 align-middle" src={phoneApps}></img> 
		</div>
		
		<div className="h-64">
			<p className="font-title text-center">Our Mission</p>
			<div className="flex justify-around items-center bg-lightPrimary">
		...
		<div className="flex items-center justify-center h-48 text-center w-full">
			<p className="font-title text-center">We do the hard work and find the best apps. 
			So you can get to enjoying life.</p>
		</div>

		<div className="flex items-center justify-center  h-64">
			<img className="h-48 w-1/3" src={spaceShip}></img>
			<div className="flex items-center flex-col">
			<p className="font-body mb-2">Launching soon. Get notified when we go live and vote for the category you want reviewed first.</p>
		...
		<div className="flex items-center justify-center h-64 text-center w-full">
			<p className="font-body text-center">Can't wait? Here's a <a href="#">sneak peak</a> article on Medium.</p>
		</div>
