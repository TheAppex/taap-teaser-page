...
const Content = () => (
  ...
  <div className="flex flex-col">
		<div className="flex content-around justify-center h-64 container mx-auto px-4">
			...
			<p className="text-3xl font-title align-middle">We are too.</p>
			</div>
		...
		<div className="flex items-center justify-center h-48 text-center w-full container mx-auto px-4">
			<p className="text-3xl font-title text-center">We do the hard work and find the best apps. 
		...
		<div className="flex items-center justify-center h-64 text-center w-full container mx-auto px-4">
			<p className="text-lg font-body text-center">Can't wait? Here's a <a href="#">sneak peek</a> article on Medium.</p>
		</div>
