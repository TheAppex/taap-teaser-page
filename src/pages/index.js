...
const IndexPage = () => (
  <div className="my-8 flex items-center flex-wrap justify-center antialiased" data-aos="fade">
    <img className=" mx-auto px-8 py-4 max-h-100" src={logo}></img>    
    <div className="container mx-auto py-8 px-6">
      <p className="text-primaryText text-center leading-normal text-xl  md:text-2xl lg:text-2xl xl:text-2xl  font-title">We recommend the best  apps for your Android device.</p>
